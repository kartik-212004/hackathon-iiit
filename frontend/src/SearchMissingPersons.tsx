...
const SearchMissingPersons = () => {
    ...
    return (
        <div>
            ...
            />
            <button onClick={handleSearch} className="bg-blue-500 text-white rounded p-2 ml-2">
                Search
            </button>
            ...
            {result && (
                <div className="mt-4">
                    ...
                    <img src={result.image} alt={result.name} className="mt-2 border rounded" style={{ width: '200px' }} />
                </div>
            )}
